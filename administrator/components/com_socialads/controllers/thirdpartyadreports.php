 ...
 * @since  1.6
 */
class SocialadsControllerThirdpartyAdReports extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since  1.6
	 */
	public function getModel($name = 'thirdpartyadreports', $prefix = 'SocialadsModel', $config = array())
	{
	...
	{
		$model   = $this->getModel("thirdpartyadreports");
