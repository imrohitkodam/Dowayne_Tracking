...
class SocialadsViewForm extends HtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->googleMapApiKey = $this->sa_params->get('google_map_api_key', '');
		...
		if ($this->ad_id)
		{
			...
			$this->map_target                           = $model->getData_map_target($ad_id);
		...
		$this->thirdPartyLocations = $model->getThirdPartyLocations();
