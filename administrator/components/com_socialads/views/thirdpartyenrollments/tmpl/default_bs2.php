			...
			<div id = "no-more-tables">
				<table class="table table-responsive mt-2" id="couponList">
					<thead>
						...
						<th class="left">
							<?php echo HTMLHelper::_('grid.sort',  'COM_SOCIALADS_THIRD_PARTY_CREATED_BY', 'u.username', $listDirn, $listOrder); ?>
						</th>
						<th class="left">
					...
					<tbody>
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td data-title="<?php echo Text::_('COM_SOCIALADS_THIRD_PARTY_CREATED_BY');?>">
									<?php
										echo $this->escape($item->created_by_username ?: 'N/A');
									?>
								</td>
								<td data-title="<?php echo Text::_('COM_SOCIALADS_THIRD_PARTY_LOCATION');?>">
									...
									<a data-toggle="modal" data-target="#locationView<?php echo $item->id ?>Modal" class="sa-btn-wrapper btn saActions">
