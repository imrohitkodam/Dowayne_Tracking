	...
	<div class="panel-body">
		<?php if (!empty($this->topads)): ?>
			<table class="table table-hover">
				<thead>
					<tr>
						<th class="col-lg-2"><?php echo Text::_("COM_SOCIALADS_ORDERS_AD_ID"); ?></th>
						<th class="col-lg-2"><?php echo Text::_("COM_SOCIALADS_ADORDERS_AD_TITLE"); ?></th>
						<th class="col-lg-2"><?php echo Text::_("COM_SOCIALADS_CTR"); ?></th>
					</tr>
				</thead>
