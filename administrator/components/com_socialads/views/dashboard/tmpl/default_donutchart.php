...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 pull-left">
			...
			<input id="btnRefresh" class="btn btn-micro btn-primary" type="button" value="<?php echo Text::_("COM_SOCIALADS_GO");?>" onclick="saAdmin.dashboard.validatePeriodicDates();Joomla.submitform();" />
		</div>
