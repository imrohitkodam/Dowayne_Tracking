			...
			<div id="filter-bar" class="btn-toolbar">
				<div class="col-md-12 mt-2">
					...
					<div class="btn-group float-end hidden-phone">
						...
						{
							echo HTMLHelper::_('select.genericlist', $this->campaignsoptions, "filter_campaignslist", 'class="input-medium form-select" size="1" onchange="document.adminForm.submit();" name="campaignslist"', "value", "text", $this->state->get('filter.campaignslist'));
						}
						?>
					</div>
					<div class="btn-group float-end hidden-phone">
				...
				<div class="col-md-12 mt-2">
					<div class="row col-md-6 form-inline fromTodateFields">
						<div class="col-md-5 col-sm-6 col-12 float-end me-2">
						...
						<div class="col-md-5 col-sm-6 col-12 float-end">
