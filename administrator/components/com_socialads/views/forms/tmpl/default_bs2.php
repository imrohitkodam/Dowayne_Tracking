		...
		<form action="<?php echo Route::_('index.php?option=com_socialads&view=forms'); ?>" method="post" name="adminForm" id="adminForm">
			<div id="filter-bar" class="btn-toolbar">
				...
				<div class="btn-group pull-right hidden-phone">
					...
					{
						echo HTMLHelper::_('select.genericlist', $this->campaignsoptions, "filter_campaignslist", 'class="input-medium" size="1" onchange="document.adminForm.submit();" name="campaignslist"', "value", "text", $this->state->get('filter.campaignslist'));
					}
					?>
				</div>
				<div class="btn-group pull-right hidden-phone">
					<?php
						echo HTMLHelper::_('select.genericlist', $this->zoneOptions, "filter_zonelist", 'class="input-medium" size="1" onchange="document.adminForm.submit();" name="zonelist"', "value", "text", $this->state->get('filter.zonelist'));
					?>
				</div>
				<div class="btn-group pull-right hidden-phone">
					<?php
						$payment_status = $this->state->get('filter.ad_approved');
						echo HTMLHelper::_('select.genericlist', $this->ostatus, "filter.ad_approved", 'class="input-large" size="1" onchange="document.adminForm.submit();" name="filter_ad_approved"', "value", "text", $this->state->get('filter.ad_approved'));
						?>
				</div>
			</div>
			<div class="row-fluid">
