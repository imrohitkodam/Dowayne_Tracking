							...
							<tbody>
								...
								<tr class="row<?php echo $i % 2; ?> <?php echo $row_color; ?>">
									...
									<td data-title="<?php echo Text::_('COM_SOCIALADS_ADORDERS_STATUS');?>">
										...
										{
											echo HTMLHelper::_('select.genericlist',$validStatus,'pstatus'.$k,'class="pad_status"  onChange="saAdmin.adorders.selectStatusOrder(' . $item->id . ',this);"',"value","text",$item->status);
										}
										else
										{
											echo $whichever ;
