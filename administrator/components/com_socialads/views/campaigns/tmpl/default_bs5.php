	...
	<form action="<?php echo Route::_('index.php?option=com_socialads&view=campaigns'); ?>" method="post"
		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="col-md-12 mt-2">
				<div class="btn-group float-start col-md-6 col-sm-12 input-group">
				...
				if (JVERSION >= '3.0') : ?>
					...
					<div class="btn-group float-end hidden-phone">
					<?php
						echo HTMLHelper::_('select.genericlist', $this->createdbyoptions, "filter_usernamelist", 'class="ad-status inputbox input-medium form-select" size="1" onchange="document.adminForm.submit();" name="usernamelist"', "value", "text", $this->state->get('filter.usernamelist'));
					?>
				</div>
				<?php endif; ?>
				<div class="btn-group float-end hidden-phone">
					...
					<tbody>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php endif; ?>
								...
								<td data-title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_TOTAL_BUDGET');?>" class="sa-text-right">
