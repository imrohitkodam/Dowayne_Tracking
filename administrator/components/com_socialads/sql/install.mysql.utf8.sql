...
`total_budget` INT(11)  NOT NULL DEFAULT 0 COMMENT 'Total budget assigned for campaign',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci;
...
`is_responsive` TINYINT(1)  NOT NULL DEFAULT 0 COMMENT 'Used for display ads in third party with non JS device',
