	...
	<div id="map_target_space" class="target_space well">
		<div class="form-group row">
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6 input-append targetting_yes_no">
				...
				<label class="first btn btn-default <?php echo $publish1_label;?>" type="button" for="maplocationcheckboxyes">
		...
		<div id="map_targett_div" class="targetting" style="<?php echo (isset($displayData->map_target) && $displayData->map_target) ? '' : 'display:none;'; ?>">
			...
			<div id="mapping-field-table">
				...
				<div class="form-group row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6 input-append targetting_yes_no selectLocationOnMapDiv">
						<input type="radio" name="selectlocationonmap" id="selectlocationonmapcheckboxyes" value="1" <?php echo $publish1;?> >
						<label class="first btn btn-default <?php echo $publish1_label;?>" type="button" for="selectlocationonmapcheckboxyes">
							<?php echo Text::_('JYES'); ?>
						</label>
				...
				<div class="form-group row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6 input-append targetting_yes_no selectLocationDiv">
						<input type="radio" name="selectlocation" id="selectlocationcheckboxyes" value="1" <?php echo $publish1;?> >
						<label class="first btn btn-default <?php echo $publish1_label;?>" type="button" for="selectlocationcheckboxyes">
							<?php echo Text::_('JYES'); ?>
						</label>
				...
				<div id="selectlocation_div" class="targetting" style="<?php echo (isset($displayData->map_target) && $displayData->map_target && $displayData->map_target['location_on']) ? '' : 'display:none;'; ?>">
					<div class="col-xs-12">
						<div class="form-group row">
							<label class="form-label col-lg-3 col-md-3 col-sm-4 col-xs-6" for="locationSelect" title="Location">
								Select Location
							</label>
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6">
								...
								echo $displayData->dropdown = HTMLHelper::_(
									...
									'class=" form-select required sa-w-100"  required="true" aria-invalid="false" size="1"
