				...
				<div class="row">
					...
					<div class="sa-info col-lg-11 col-md-11 col-sm-11 col-xs-11">
								...
								<div>
									...
									?>
										<?php echo HTMLHelper::_(
											...
											'class="ad-type chzn-done" size="1" onchange="sa.create.changeAdType()"',
								...
								<div id="defaulturl1">
									...
									<div class="" id="sa-form-spantxt">
										<div id="enterlink">
											...
											<input class="inputbox url sa-w-80" type="text" id="url2" name="addata[ad_url2]"
						...
						<div class="form-group" id='ad_title_name'>
							...
							<div id='ad_title_box'>
								<input class="sa-w-100" type="text" id="ad_title" value="<?php echo htmlspecialchars($displayData->ad_title_edit, ENT_COMPAT, 'UTF-8'); ?>"
