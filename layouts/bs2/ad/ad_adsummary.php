			...
			<div class="span6">
				...
				<div class="table-responsive">
					<table class=" table table-bordered">
						...
						{
							$ad_chargeOpKey = ($this->chargeoption == 1) ? Text::_('COM_SOCIALADS_NUMBER_CLICKS') : Text::_('COM_SOCIALADS_NUMBER_IMPRESSIONS');
						...
						<div class="control-group " id="sa_paymentGatewayList">
							...
							<div class="controls" style="<?php echo ($gateway_div_style == 1) ? "" : "display:none;" ?>">
								...
								else
								{
									...
									$pg_list = HTMLHelper::_('select.radiolist', $this->ad_gateways, 'ad_gateways', 'class="inputbox required" ' .
