		...
		<div class="form-horizontal container-fluid">
			...
			<div class="form-group row">
				...
				<div class="controls form-inline col-md-4">
					<?php
					echo HTMLHelper::_('select.genericlist', $campaignOptions, "ad_campaign", 'class="chzn-done ml-18 form-select" onchange="sa.create.hideNewCampaign()"', "value", "text", $displayData->camp_id);
			...
			<div id="new_campaign" class="form-group row <?php echo $show_new_campaign_box; ?>">
				...
				<div class="col-md-8">
					<div class="form-inline row ms-4">
						<input type="text" class="col-md-6 form-control" id="camp_name" name="camp_name" placeholder="<?php echo JText::_('COM_SOCIALADS_ENTER_CAMPAIGN_NAME'); ?>" title="<?php echo JText::_('COM_SOCIALADS_ENTER_CAMPAIGN_NAME'); ?>" value="<?php // echo $displayData->cname; ?>">
						<div class="col-md-6">
