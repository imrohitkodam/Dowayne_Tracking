...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $displayData->googleMapApiKey; ?>&libraries=drawing,geometry&loading=async&callback=initMap" async defer></script>

<script type="text/javascript">
var totalPopulationForAdPreview = {};
</script>
