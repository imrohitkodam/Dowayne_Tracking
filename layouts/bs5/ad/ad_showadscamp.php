...
elseif($displayData->AdPreviewData->ad_payment_type == 4)
{
	$mode = Text::_('COM_SOCIALADS_CHARGE_TOGETHER');
}
			...
			<div class=" row show-grid">
				...
				<div class="col-md-6 sa-overflow-x">
					...
					<div class="row ">	
						...
						<?php 
						if ($displayData->mapTargetData)
						{
							?>
							<div class="col-sm-12 col-md-4"> <strong><?php echo Text::_('COM_SOCIALADS_AD_SHOW_TOTAL_POPULATION'); ?> </strong> </div>
							<div class="col-sm-12 col-md-8">
								<div><?php echo $displayData->mapTargetData['count']; ?></div>
							</div>
							<?php
						}
						if(count($displayData->displayAdsInfo['geo']))
						{
						?> 
