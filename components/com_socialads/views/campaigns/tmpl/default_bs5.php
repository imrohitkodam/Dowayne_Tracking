	...
	<form action="<?php echo Route::_('index.php?option=com_socialads&view=campaigns'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-12  ">
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button type="button" onclick="this.form.submit();" class="button btn btn-md  btn-outline-secondary" data-original-title="Search">
							<i class="fa fa-search" aria-hidden="true"></i>
						</button>
						<button onclick="document.getElementById('filter_search').value='';this.form.submit();" type="button" class="button btn btn-md  btn-outline-secondary" data-original-title="Clear">
							<i class="fa fa-remove" aria-hidden="true"></i>
						</button>
					</span>
				</div>
			</div>
			<div class="col-xs-2 col-sm-6 col-md-5 col-lg-5">
		...
		<?php
			...
			<div id="no-more-tables" class="table-responsive ads-list">
				<table class="table table-responsive" id="campaignList">
					<thead>
						<tr>
							...
							<th class="sa-text-right">
								<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_TOTAL_BUDGET'); ?>
							</th>
							<th class="sa-text-right">
					...
					<tbody>
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="sa-text-right" data-title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_TOTAL_BUDGET');?>">
									<?php echo SaCommonHelper::getFormattedPrice($item->total_budget, '', $this->params->get('decimals_count', 2)); ?>
								</td>
