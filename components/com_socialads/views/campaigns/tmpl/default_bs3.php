			...
			<div class="col-lg-5 col-md-5 col-sm-6 col-xs-12  ">
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button type="button" onclick="this.form.submit();" class="button btn btn-md btn-small mb-10" data-original-title="Search">
							<i class="fa fa-search" aria-hidden="true"></i>
						</button>
					</span>
					<span class="input-group-btn">
						<button onclick="document.getElementById('filter_search').value='';this.form.submit();" type="button" class="button btn btn-md btn-small mb-10" data-original-title="Clear">
