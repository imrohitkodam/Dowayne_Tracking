		...
		<div id="container">
			...
			?>
				...
				<div class="btn-group pull-left">
					<button class="btn btn-small hasTooltip" type="submit" title="<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>">
						<i class="fa fa-search"></i>
					</button>
					<button class="btn btn-small hasTooltip" id="clear-search-button" type="button" title="<?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?>">
			...
			<div class="col-md-12">
				<div class="row sa-mt-1">
					<div class="form-inline pull-right fromTodateFields">
						<div class="col-md-6 col-sm-6 col-12 pull-left">
