	...
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div id="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row mt-1">
						<div class="form-inline float-end fromTodateFields">
							<div class="col-md-4 col-sm-6 col-12 float-end">
							...
							<div class="col-md-4 col-sm-6 col-12 float-end me-2">
					...
					<div class="row mt-2">
						<div class="col-md-12 col-sm-12 col-12">
							...
							<div class="btn-group float-end hidden-phone hidden-tablet social-ads-filter-margin-left">
								<?php
									...
									<tr class="row<?php echo $i % 2;?>">
										...
										<td data-title="<?php echo Text::_('COM_SOCIALADS_ADS_AD_TITLE');?>" class="">
											...
											if ($canDo->get("core.edit")): ?>
												<a href="<?php echo Route::_('index.php?option=com_socialads&view=adform&ad_id='.(int) $item->ad_id). '&Itemid=' . $this->socialAdsitemId, false; ?>">
										...
										<td class="text-center actions" data-title="<?php echo Text::_('COM_SOCIALADS_ADS_IGNORES');?>">
											<?php
