		...
		<div class="tab-content">
			<div class="tab-pane container active" id="profile">
				...
				<div class="form-group row countDisplayFormRow <?php echo empty($this->item->id) ? 'd-none' : ''; ?>">
					<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 form-label">Total <?php echo Text::_('COM_SOCIALADS_THIRD_PARTY_POPULATION_COUNT'); ?></div>
					<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12"><input type="text" readonly class="form-control countDisplayInTextbox" value="<?php echo (!empty($this->item->id)) ? $this->form->getValue('count') : ''; ?>"></div>
				</div>

				<div class="form-group row">
					<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 form-label"><?php echo Text::_('COM_SOCIALADS_THIRD_PARTY_SELECT_LOCATION'); ?></div>
			...
			<div class="tab-pane container" id="widgetCode">
				...
				?>
					...
					<div class="form-group row widgetDisplayFormRow d-none">
						...
						<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
							<input type="text" class="form-control imageLinkURL" disabled >
						</div>
					</div>
					...
					<div class="form-group row widgetDisplayFormRow d-none">
						...
						<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
							<input type="text" class="form-control urlLinkURL" disabled >
						</div>
					</div>
				<?php
				} ?>
			...
			if (status === 'OK') {
				if (results[0]) {
					...
					if (city != null &&
						...
						country != null) 
					{
						const addressIsPresent = circles.find(circle => (circle.city === city && circle.region === region));
