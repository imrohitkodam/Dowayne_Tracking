...
<div class="<?php echo SA_WRAPPER_CLASS;?>" id="sa-wallet">
	...
	<form action="" method="post" name="adminForm3" id="adminForm3">
								...
								<table class="table table-condensed table-responsive">
									<thead>
										<tr>
											...
											<th>
												<?php echo HTMLHelper::tooltip(Text::_('COM_SOCIALADS_WALLET_PAYMENT_STATUS'), '', '', Text::_('COM_SOCIALADS_WALLET_PAYMENT_STATUS'));?>
											</th>
									...
									foreach ($statesticsInformation as $key)
									{
										...
										<tr>
											...
											<td data-title="<?php echo Text::_('COM_SOCIALADS_WALLET_PAYMENT_STATUS');?>">
												<?php
													if ($key->order_status == 'P')
													{
														echo Text::_('COM_SOCIALADS_WALLET_PAYMENT_STATUS_PENDING');
													} 
													elseif ($key->order_status == 'C')
													{
														echo Text::_('COM_SOCIALADS_WALLET_PAYMENT_STATUS_CONFIRMED');
													} else
													{
														echo htmlspecialchars($key->order_status);
													}
												?>
											</td>
		...
		<div class="row mt-3">
			<div class="col-md-6 col-sm-12">
				<div class="form-actions" >	
					<div class="input-group row">
						<label class="form-label col-md-4" title="<?php echo Text::_('COM_SOCIALADS_WALLET_DESC_REDEEM_COUPON'); ?>">
			...
			<div class="col-md-6 col-sm-12">
				<a href="<?php echo Route::_('index.php?option=com_socialads&view=payment&Itemid='.$this->paymentitemid); ?>" class="btn btn-success btn-sm float-end"><?php echo Text::_('COM_SOCIALADS_AD_PAYMENT'); ?></a>
			</div>
		</div>
