...
<div class="<?php echo SA_WRAPPER_CLASS;?>" id="sa-myorders">
	...
	<form action="<?php echo Route::_('index.php?option=com_socialads&view=myorders'); ?>" method="post" name="adminForm" id="adminForm">
		...
		?>
			<div id="no-more-tables" class="table-responsive">
				<table class="table table-responsive 	table-bordered table-hover" id="reportList">
					<thead>
						<tr>
							<th class=''>
