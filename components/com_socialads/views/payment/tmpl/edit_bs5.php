...
<div class="<?php echo SA_WRAPPER_CLASS;?>" id="sa-payment">
	<script type="text/javascript">
		...
		techjoomla.jQuery(document).ready(function()
		{
			...
			techjoomla.jQuery("#amount_tab").click(function() {
				var isSelected = jQuery('#pay_gateway input[name="ad_gateways"]:checked').length > 0;

				if (isSelected) {
					jQuery('#pay_gateway input[name="ad_gateways"]:checked').prop('checked', false);
					jQuery('#html-container').html('');
				}
			});
		});
	</script>
					...
					<div class="tab-pane fade show active" id="amount" role="tabpanel" aria-labelledby="amount_tab">
						<div class="row">
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-9 col-xs-12" id="amount">
							...
							<div class="form-group row coupon-display" id="showCoupon">
								...
								<div class="col-lg-6 col-md-6 col-sm-9 col-xs-12 controls">
									<label class="radio">
						...
						<div class="row">
							<div class="col-md-12">
								<a class="float-end btn btn-primary btn-sm showNextTab make-payment-page"><?php echo Text::_('COM_SOCIALADS_SAVE_AND_NEXT');?></a>
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="payment_infor" role="tabpanel" aria-labelledby="payment_infor_tab">
						...
						<div class="form-group row" id="pay_gateway">
